...
public class AvatarInputConverter : MonoBehaviour
{
    ...
    void Update()
    {
        //Lerp is interpolation between two points, used to smoothen the transition between one point to another.
        //Head and Body synch
        ...
        AvatarBody.rotation = Quaternion.Lerp(AvatarBody.rotation, Quaternion.Euler(new Vector3(0, AvatarHead.rotation.eulerAngles.y, 0)), 0.05f); // only lerp the y rotation, not x or z.
